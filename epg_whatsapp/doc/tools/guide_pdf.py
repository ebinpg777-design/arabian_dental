...
label = sys.argv[3] if len(sys.argv) > 3 else "WhatsApp — Setup and User Guide · epg_whatsapp"
footer = f"""<div style="font-size:8px;color:#6b7280;width:100%;padding:0 15mm;display:flex;justify-content:space-between;">
<span>{label}</span>
